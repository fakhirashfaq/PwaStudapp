...
/**
 * @description Send mail for subscription
 */
export const sendSubscribeNewsletterMail = functions.https.onCall(async (data, context) => {

   const email: string = data.email;

   if (!(!!email)) { // Invalid request parameters
      console.error("No email provided for subscription");
   ...
   await transporter.sendMail(getMailContent(email)).then(() => {
      console.info("Subscription mail sent to user: ", email)
      return Promise.resolve();
   }).catch((error: any) => {
      console.error("Error sending subscription mail to user: " + email, error);
...
/**
 * @description Get email subscription content
 *
 * @param {string} email
 * @returns {*}
 */
                                                                           ...
                                                                           <table cellpadding="0" cellspacing="0" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" valign="top" width="100%">
                                                                              <tr style="vertical-align: top;" valign="top">
                                                                                 <td align="center" style="word-break: break-word; vertical-align: top; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; padding-top: 0px; text-align: center; width: 100%;" valign="top" width="100%">
                                                                                    <h1 style="color:#000000;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:26px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><strong>Subscribed!!</strong></h1>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
                                                                           <!--[if (!mso)&(!IE)]><!-->
                                                                              ...
                                                                              <tr>
                                                                                 <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                    ...
                                                                                    <div style="color:#585858;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                       <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #585858; mso-line-height-alt: 17px;">
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">Thanks for subscribing to STUBUD.<br/></span></p><br>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p><br>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;">You will now receive regular updates, promotions and newsletters from us.</p><br>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p><br>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">Reply to this email if you have any questions. We are here to help!</span></p>
                                                                                       </div>
                                                                                    </div>
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                                 ...
                                                                                 <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                    ...
                                                                                    <div style="color:#ffffff;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                       <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #ffffff; mso-line-height-alt: 17px;">
                                                                                          <p style="margin: 0; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">You received this email because you are subscribed to communications from STUBUD Ltd.</p><br>
                                                                                          ...
                                                                                          <p align="center" style="margin: 0; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">To ensure any delivery to your inbox, be sure to mark us as a Safe Sender by adding our email address to your contacts or address book.</p><br>
                                                                                          <p align="center" style="margin: 0; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"> </p>
                                                                                          <p align="center" style="margin: 0; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;"><a href="https://us-central1-stubud-bb83b.cloudfunctions.net/unsubscribeNewsletter/${email}" style="color: #ffffff;">Unsubscribe from this list</a></p>
                                                                                       </div>
                                                                                    </div>
                                                                                    <!--[if mso]>
                                                                                 </td>
