...
export const authUserOnCreate = functions.auth.user().onCreate(async (user) => {
   ...
   await transporter.sendMail(getMailContent(user.email!)).then(() => {
      console.log("Welcoming email sent to : ", user.email)
      return Promise.resolve();
   }).catch((error: any) => {
      console.log("Error sending welcoming mail to : " + user.email, error);
      throw new functions.https.HttpsError('unknown', "Nodemailer failed to send mail to : " + user.email);
   });
});

/**
 * @description Get welcoming email content
 *
 * @param {string} userEmail
 * @returns {*}
 */
function getMailContent(userEmail: string): any {
   return { // setup e-mail data with unicode symbols
      ...
      tile: `Hello There`,
      subject: `Welcome to STUBUD`, // Subject line
      html: `
                     ...
                     <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                           <td align="center" style="background-color:#FFFFFF">
                                                                           ...
                                                                           <table cellpadding="0" cellspacing="0" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" valign="top" width="100%">
                                                                              <tr style="vertical-align: top;" valign="top">
                                                                                 <td align="center" style="word-break: break-word; vertical-align: top; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; padding-top: 0px; text-align: center; width: 100%;" valign="top" width="100%">
                                                                                    <h1 style="color:#000000;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:26px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><strong>Welcome to STUBUD</strong></h1>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
                                                                           <!--[if (!mso)&(!IE)]><!-->
                                                                              ...
                                                                              <tr>
                                                                                 <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                    ...
                                                                                    <div style="color:#585858;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                       <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #585858; mso-line-height-alt: 17px;">
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">We’re thrilled to welcome you at STUBUD.</span></p><br>
                                                                                          ...
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">Here at STUBUD, we verify students for them to have access to exclusive services like discounts and also allow student-friendly brands offering these exclusive services to protect their business margin.</span></p><br>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">To get your account verified by us, students must have a student institution email address (university email) or upload either your school ID card, Acceptance letter or transcript issued by your institution.</span></p><br>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p>
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">If you’re a student and would like to benefit from all services, continue the registration process to get a valid STUBUD account.</span></p>
                                                                                       </div>
                                                                                    </div>
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              ...
                                                                              <table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                                                                                 <tr>
                                                                                    <td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center">
                                                                                       <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://stubud-bb83b.firebaseapp.com/auth/register" style="height:39pt;width:288pt;v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#04a3ff">
                                                                                          <w:anchorlock/>
                                                                                          <v:textbox inset="0,0,0,0">
                                                                                             <center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
                                                                                                <![endif]--><a href="https://stubud-bb83b.firebaseapp.com/auth/register" style="-webkit-text-size-adjust: none; text-decoration: none; display: block; color: #ffffff; background-color: #04a3ff; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; width: 80%; width: calc(80% - 2px); border-top: 1px solid #04a3ff; border-right: 1px solid #04a3ff; border-bottom: 1px solid #04a3ff; border-left: 1px solid #04a3ff; padding-top: 10px; padding-bottom: 10px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:10px;padding-right:10px;font-size:16px;display:inline-block;letter-spacing:1px;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">CONTINUE REGISTRATION</span></span></a>
                                                                                                <!--[if mso]>
                                                                                             </center>
                                                                                          </v:textbox>
                                                                                       </v:roundrect>
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr>
                                                                                 <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                    ...
                                                                                    <div style="color:#585858;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                       <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #585858; mso-line-height-alt: 17px;">
                                                                                          <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">You can also find more of STUBUD here to learn more about How STUBUD works.</span></p>
                                                                                       </div>
                                                                                    </div>
                                                                                    <!--[if mso]>
                                                                                 </td>
                              ...
                              <div style="background-color:transparent;">
                                 <div class="block-grid" style="min-width: 320px; max-width: 500px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #04a3ff;">
                                                                                 ...
                                                                                 <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                    ...
                                                                                    <div style="color:#ffffff;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                       <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #ffffff; mso-line-height-alt: 17px;">
                                                                                          <p align="center" style="margin: 0; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">You received this email because you signed up to STUBUD Ltd.</p><br>
