...
/**
 * @description Send mail when user uploads files for verification
 */
export const manualVerificationMail = functions.https.onCall(async (data, context) => {
   ...
   const transporter = nodemailer.createTransport({ // Create A Nodemailer Transporter. transporter is going to be an object that is able to send mail
      ...
      secure: true,
      auth: {
         user: 'services@stubud.com',
         pass: 'TempP@ass2021'
      }
   });

   await transporter.sendMail(getMailContent(email, firstName)).then(() => {
      console.info("Manual Verification mail sent to : ", email)
      return Promise.resolve();
   }).catch((error: any) => {
      console.error("Error sending manual verification mail to user: " + email, error);
...
/**
 * @description Get email for manual verification
 *
 * @param {string} email
 * @param {string} firstName
 * @returns {*}
 */
function getMailContent(email: string, firstName: string): any {
   return { // setup e-mail data with unicode symbols
      from: 'Stubud <services@stubud.com>', // sender address
      to: email, // list of receivers
      bcc: 'kar39.stubud@gmail.com, services@stubud.com',
      tile: `Hello There`,
      subject: `Manual Verification`, // Subject line
      html: `
                                                                               ...
                                                                               <table cellpadding="0" cellspacing="0" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" valign="top" width="100%">
                                                                                  <tr style="vertical-align: top;" valign="top">
                                                                                     <td align="center" style="word-break: break-word; vertical-align: top; padding-bottom: 0px; padding-left: 0px; padding-right: 0px; padding-top: 0px; text-align: center; width: 100%;" valign="top" width="100%">
                                                                                        <h1 style="color:#000000;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:26px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;"><strong>Manual Verification</strong></h1>
                                                                                     </td>
                                                                                  </tr>
                                                                               </table>
                                                                               <!--[if (!mso)&(!IE)]><!-->
                                                                                  ...
                                                                                  <tr>
                                                                                     <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                        ...
                                                                                        <div style="color:#585858;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                           <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #585858; mso-line-height-alt: 17px;">
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"><span style="font-size: 17px; mso-ansi-font-size: 18px;">We received your files </span>${firstName}.</p>
                                                                                              <br>
                                                                                              ...
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;">Sit back and we will go through each one of them as soon as possible.</p>
                                                                                              <br>
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p>
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;">Once verified and accepted, we will validate your account and you shall possess a valid STUBUD account.</p>
                                                                                              <br>
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p>
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;">Have a great day,</p>
                                                                                              <br>
                                                                                              <p style="margin: 0; font-size: 17px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 20px; mso-ansi-font-size: 18px; margin-top: 0; margin-bottom: 0;"> </p>
                                                                                     ...
                                                                                     <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                        ...
                                                                                        <div style="color:#ffffff;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                           <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #ffffff; mso-line-height-alt: 17px;">
                                                                                              <p style="margin: 0; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">You received this email because you requested a manual verification of your  STUBUD account.</p>
                                                                                              <br>
                                                                                     ...
                                                                                     <td style="padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px; font-family: Arial, sans-serif">
                                                                                        ...
                                                                                        <div style="color:#ffffff;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                                                                           <div class="txtTinyMce-wrapper" style="font-size: 14px; line-height: 1.2; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #ffffff; mso-line-height-alt: 17px;">
                                                                                              ...
                                                                                              <p style="margin: 0; text-align: center; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">17, Mallac Street | Rose-Hill | Mauritius</p>
